...
\addcontentsline{toc}{chapter}{附录A\hspace{1em}西南交通大学二级单位中英文名称对照表}
...
\addcontentsline{toc}{chapter}{附录B\hspace{1em}常见一级学科中英文名称对照表}
\setcounter{equation}{0}
\setcounter{figure}{0}
\setcounter{table}{0} 
...
\addcontentsline{toc}{chapter}{附录C\hspace{1em}西南交通大学专业学位研究生授予学位类别一览表}
\setcounter{equation}{0}
\setcounter{figure}{0}
\setcounter{table}{0} 
